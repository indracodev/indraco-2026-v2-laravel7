      ...
      <form class="modal-content py-3" action="{{ route('products.index') }}" method="GET" role="search">
         ...
         <div class="container-fluid">
            <div class="input-group mb-4">
               ...
               <input class="form-control form-control-lg border-2 border-start-0 border-end-0 px-0" type="search" name="search" id="search" placeholder="Search Our Products" value="{{ request('search') }}">
