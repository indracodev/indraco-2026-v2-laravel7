      ...
      <form class="modal-content py-3" action="{{ route('products.index') }}" method="GET" role="search">
         ...
         <div class="container-fluid">
            <div class="input-group mb-4">
               ...
               <input class="form-control border-2 border-start-0 border-end-0 px-0" type="search" name="search" id="search" placeholder="Search Our Products" value="{{ request('search') }}">
            ...
            <nav class="mb-4" aria-label="Popular keywords">
               <ul class="nav gap-2">
                  <li><a href="{{ route('products.index') }}?search=Sumatra" class="btn btn-sm rounded-1 btn-outline-invert">Sumatra Mandheling</a></li>
                  <li><a href="{{ route('products.index') }}?search=Coffee" class="btn btn-sm rounded-1 btn-outline-invert">Coffee</a></li>
                  <li><a href="{{ route('products.index') }}?search=Capsules" class="btn btn-sm rounded-1 btn-outline-invert">Coffee Capsules</a></li>
                  <li><a href="{{ route('products.index') }}?search=Jahe" class="btn btn-sm rounded-1 btn-outline-invert">Jaheku</a></li>
               </ul>
            </nav>
